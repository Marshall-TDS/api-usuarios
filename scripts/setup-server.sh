...
echo "🔧 Configurando servidor VPS para deploy da API de Usuários..."
...
PROJECT_DIR="/var/www/api-usuarios"
...
echo "2. Crie o arquivo .env com as variáveis de ambiente"
echo "3. Configure as secrets no GitHub Actions"
echo "4. Faça push para a branch homolog para iniciar o deploy automático"
